...
Parser parser_init(String filename0, String content0);
...
i32 entry()
{
    ObjectList files1 = NULL;
    ObjectList units2 = NULL;
    i32 i3;
    String file4 = NULL;
    ...
    Object outputFile10 = NULL;
    Emitter emitter11 = NULL;
    GC_FRAME_INIT(10, GC_LOCAL(files1), GC_LOCAL(units2), GC_LOCAL(file4), GC_LOCAL(content5), GC_LOCAL(parser6), GC_LOCAL(unit7), GC_LOCAL(binder8), GC_LOCAL(program9), GC_LOCAL(outputFile10), GC_LOCAL(emitter11));
    {
        files1 = (list_init)();
        ...
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/lexer.lop", 17))));
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/parser.lop", 18))));
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/conversion.lop", 22))));
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/scope.lop", 17))));
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/binder.lop", 18))));
        (list_push)(files1, ((Object)(STRING_CTOR(String_impl, String_type, (uchar*)"./input/c_emitter.lop", 21))));
        units2 = (list_init)();
        i3 = 0;
        while (i3 < (files1)->length)
        {
            file4 = ((String)((list_get_value)(files1, i3)));
            i3 = i3 + 1;
            content5 = (fs_read_file)(file4);
            parser6 = (parser_init)(file4, content5);
...
{
    Lexer lexer1 = NULL;
    GC_FRAME_INIT(3, GC_LOCAL(filename0), GC_LOCAL(content0), GC_LOCAL(lexer1));
    {
...
Parser parser_init(String filename0, String content0)
{
    ...
    Token token3 = NULL;
    Parser parser4 = NULL;
    GC_FRAME_INIT(6, GC_LOCAL(filename0), GC_LOCAL(content0), GC_LOCAL(lexer1), GC_LOCAL(tokens2), GC_LOCAL(token3), GC_LOCAL(parser4));
    {
        lexer1 = (lexer_init)(filename0, content0);
        tokens2 = (list_init)();
